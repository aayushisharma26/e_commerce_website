      ...
      <div className="container-fluid" style={{ height: "60px" }}>
        <div className="d-flex align-items-center">
          ...
          <div className="navbar-brand" aria-current="page">
            <Link href="/product_list/electronics" style={{ color: 'blue', marginLeft: "20px",fontFamily:'Inika',textDecoration: 'none' }}>Electronics</Link>
          </div>

          <div className="navbar-brand" aria-current="page">
            <Link href="/product_list/jewelery" style={{ color: 'blue',fontFamily:'Inika',textDecoration: 'none' }}>Jewellery</Link>
          </div>

          <div className="navbar-brand" aria-current="page">
            <Link href="/product_list/men's clothing" style={{ color: 'blue',fontFamily:'Inika',textDecoration: 'none' }}>Mans_Cloths</Link>
          </div>

          <div className="navbar-brand" >
            <Link href="/product_list/women's clothing" style={{ color: 'blue',fontFamily:'Inika',textDecoration: 'none' }}>Womans_Cloths</Link>
          </div>
